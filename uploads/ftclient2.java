...
//check file if already selceted or not foe uploading
...
if(files.size()==0)
{
JOptionPane.showMessageDialog(FTClientFrame.this,"No files selected upload");
return;
}
...
System.out.println("number of bytes uploaded : "+numberOfBytesUploaded);
...
System.out.println("Progress bar updated : "+percentage);
if(percentage==100) 
{
...
fue.setFile(file);
fue.setNumberOfBytesUploaded(brc); //done
